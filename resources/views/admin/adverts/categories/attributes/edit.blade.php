...
@section('content')
    ...
    <form method="POST" action="{{ route('admin.adverts.categories.attributes.update', [$category, $attribute]) }}">
        ...
        <div class="form-group">
            ...
            <input type="text" id="name" class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" name="name" value="{{ old('name', $attribute->name) }}" required>
            @if($errors->has('name'))
        ...
        <div class="form-group">
            ...
            <input type="text" id="name" class="form-control{{ $errors->has('sort') ? ' is-invalid' : '' }}" name="name" value="{{ old('sort', $attribute->sort) }}" required>
            @if($errors->has('sort'))
        ...
        <div class="form-group">
            ...
            <input type="text" id="name" class="form-control{{ $errors->has('sort') ? ' is-invalid' : '' }}" name="name" value="{{ old('variants', implode("\n", $attribute->variants)) }}" required>
